...
# req = requests.get('https://www.dataforthai.com/login')  # HTTP GET Request

with requests.Session() as s:
    login_req = s.post('https://www.dataforthai.com/login', data=LoginInfo)
    print(login_req.status_code) #로그인이 정상적으로 되었는지 확인용도
